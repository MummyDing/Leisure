...
public class ReadingApi {
    ...
    public static String NovelTag[] ={"漫画","绘本", "推理", "青春", "言情","科幻", "东野圭吾", "悬疑", "武侠", "韩寒", "奇幻", "日本漫画", "耽美", "亦舒", " 三毛", "安妮宝贝", "网络小说", "郭敬明", "推理小说", "穿越", "金庸", "轻小说", "几米", "阿加莎·克里斯蒂","张小娴", "幾米", "魔幻", "青春文学", "J.K.罗琳", "科幻小说", "高木直子", "古龙", "沧月", "蔡康永", "落落", "张悦然"};
    ...
    public static String ScienceTag[] ={"编程", "科学", "交互", "设计", "算法", "web", "科技", "UE", "科普", "互联网", "用户体验", "通信", "交互", "UCD"};
